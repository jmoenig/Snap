SnapTranslator.dict.ua = {
    ...
    "Dragging threshold...": "Перетягування порогу...",
    ...
    "Edge color (left click)": "Колір краю (клікніть лівою кнопкою миші)",
    ...
    "Extension blocks": "Розширювальні блоки",
    ...
    "Glide, grow and rotate using easing functions.": "Ковзайте, збільшуйте та обертайте за допомогою функцій полегшення.",
    ...
    "If you cannot find that email, please check your spam folder.": "Якщо ви не можете знайти цей електронний лист, будь ласка, перевірте папку зі спамом.",
    ...
    "Run a script; if an error happens, instead of stopping the script with a red halo, run another script to handle the error. Also includes a block to cause an error with a message given as input. Also includes a block to create a script variable and give it a value.": "Запустіть сценарій; якщо сталася помилка, замість того, щоб зупинити сценарій із червоним ореолом, запустіть інший сценарій, щоб обробити помилку. Також містить блок, який викликає помилку з повідомленням, наданим як вхід. Також містить блок для створення змінну сценарію та надайте їй значення.",
    "Run several scripts in parallel and wait until all are done.": "Запустіть кілька сценаріїв паралельно та зачекайте, поки всі будуть виконані",
    "SVG costumes are not yet fully supported in every browser": "Костюми SVG ще не повністю підтримуються в усіх браузерах",
    ...
    "Scenes...": "Сцени...",
    "Script variable name": "Ім'я змінної скрипта",
    "Scripts": "Скрипти",
    ...
    "Up": "Вгору",
    "Updating project list...": "Оновлення списку проектів...",
    ...
    "_ map _ over _": "_ карта _ над _",
    ...
    "a variable of name '": "змінна імені '",
    ...
    "caller": "абонент",
    "camera": "камера",
    "can only write text or numbers, not a": "може писати лише текст або цифри, не a",
    ...
    "check to enable project data in URLs": "позначте, щоб увімкнути дані проекту в URL",
    ...
    "draggable": "рухомий",
    "draggable?": "відчутний?",
    "dragging threshold": "перетягування порога",
    "dropped": "кинуть",
    "duplicate": "дублювати",
    ...
    "map String to code _": "зіставити рядок із кодом _",
    "map _ of _ to code _": "карта _ з _ на код _",
    "map _ over _": "встановити _ над _",
    "map _ to _ _": "карта _ до _ _",
    "max": "максимальна",
    "maximum": "максимум",
    ...
    "pick up": "забрати",
    "pipe _ $arrowRight _": "труба _ $arrowRight _",
    "pipette": "піпетка",
    "pitch": "подача",
    ...
    "set _ of block _ to _": "набір _ блоку _ до _",
