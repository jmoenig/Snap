SnapTranslator.dict.zh_CN = { ...SnapTranslator.dict.zh_CN,
    ...
    "check to show extension\nprimitives in the palette": "显示“extension”及“primitive”积木，以使用自定义扩展\n注：用户编辑的自定义扩展通过内置扩展函数“src_load(url)”导入",
    ...
    "Export project...": "导出项目...",
    "export script": "导出脚本",
    "Export summary with drop-shadows...": "导出项目预览的HTML文件(带阴影)...",
    "Export summary...": "导出项目预览的HTML文件",
    "export...": "导出...",
    "Exported!": "导出好了！",
    "Extension blocks": "使用自定义扩展(自定义扩展函数(组))？",
    "extensions": "扩展(函数)",
    "extent": "范围",
    "extract": "提取",
    ...
    "this project doesn't have any custom global blocks yet": "这个项目未包含全局自制积木",
    "this script": "这个脚本",
