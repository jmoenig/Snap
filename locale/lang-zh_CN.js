SnapTranslator.dict.zh_CN = { ...SnapTranslator.dict.zh_CN,
  ...
  "_ mod _": "_ mod _",
  "_ of _": "取属性 _ 于 _",
  "_ of block _": "属性 _ 自积木 _",
  "_ of color _": "属性 _ 自颜色 _",
  "_ of costume _": "取属性 _ 于造型 _",
  "_ of sound _": "取属性 _ 于声音 _",
  "_ of text _": "取属性 _ 于文本 _",
  "_ on _": "_ 在 _ 上",
  "_ to _": "_ 到 _",
  "__shout__go__": "",
  "a": "a",
  ...
  "check for multi-column\nlist view support": "以表格形式简化多维(如2维)列表的可视化",
  ...
  "check to always show slot\ntypes in the input dialog": "编辑参数时，直接显示完整的设置界面",
  ...
  "check to enable alternating\ncolors for nested blocks": "使用明暗交替的颜色\n区分处于同一类型的嵌套积木",
  "check to enable auto-wrapping\ninside nested block stacks": "选中以启用嵌套积木堆栈内的自动换行",
  "check to enable dynamic\nlabels for variadic inputs": "可变参数使用动态标记",
  "check to enable support\n for first-class sprite": "将角色当作一等公民",
  "check to enable using operators on lists and tables": "勾选以启用作用于N维列表(包括“表格”)的超级运算符",
  ...
  "check to show extension\nprimitives in the palette": "显示“extension”及“primitive”积木，以分别使用已导入的扩展函数和原生积木函数",
  "check to support\nnative JavaScript functions": "勾选以解除JavaScript Function积木的使用限制",
  "check to switch pen colors\nand graphic effects to HSL": "勾选后将画笔颜色样式设置为HSL",
  "check to turn\nblock clicking\nsound on": "点击积木时发出声音",
  ...
  "compile": "编译",
  "compile _": "编译 _",
  "compile _ for _ args": "编译脚本 _ 参数数量： _",
  "Computer": "计算机",
  "conditionals": "多分支判断(可变参数)",
  "confetti": "彩纸",
  ...
  "disable dragging media\nand blocks out of\nwatchers and balloons": "禁止从返回框或对话框里拖动造型、声音或积木",
  ...
  "Enter code that corresponds to the block's definition. Choose your own\nformal parameter names (ignoring the ones shown).": "输入积木对应的代码定义/实现，\n使用自己选择的形参名字(忽略上图所示的形参名)。",
  "Enter code that corresponds to the block's definition. Use the formal parameter names as shown and <body> to reference the definition body's generated text code.": "输入积木对应的代码定义/实现。使用上图所示的形参名，使用<body>来标识积木的代码定义。",
  "Enter code that corresponds to the block's operation (usually a single\nfunction invocation). Use <#n> to reference actual arguments as shown.": "输入积木对应的转换代码，用<#n>来标识上图所示的实参。",
  ...
  "entering development mode.\n\nerror catching is turned off,\nuse the browser's web console\nto see error messages.": "已进入开发者模式，针对Snap!的报错机制已停用。请通过浏览器控制台，查看接下来的报错信息。",
  "entering user mode": "已进入用户模式",
  "epochs": "迭代次数",
  "erase": "擦除",
  "eraser": "橡皮擦",
  "Eraser tool": "橡皮",
  ...
  "experimental! make this reporter fast and uninterruptable CAUTION: Errors in the ring can break your Snap! session!": "实验性功能！使这个报告器快速和不可中断。注意：环中的错误可能会破坏您的Snap! 会话！",
  "EXPERIMENTAL! optimize Canvas2D readback operations using the \"willReadFrequently\" attribute at the expense of slowing down rendering in some web browsers": "实验性功能！使用 'willReadFrequently' 属性来优化 Canvas2D 读取操作，但可能会降低某些网页浏览器的渲染速度",
  ...
  "export project as cloud data...": "以云端数据格式导出作品...",
  "Export project as plain text...": "以文字格式导出作品...",
  "Export Project As...": "把作品导出到...",
  "export project media only...": "仅导出作品中的素材...",
  "export project without media...": "导出作品,不含素材...",
  "Export project...": "导出作品...",
  "export script": "导出脚本",
  ...
  "JIT compiler support": "使用JIT编译(\"编译脚本...参数数量...\"积木)？",
  "join _": "把 _ 连起来",
  "jukebox": "全部声音",
  "July": "七月",
  "June": "六月",
  ...
  "Logout": "登出",
  "long (10x)": "较长 (10秒)",
  "Long form input dialog": "优先显示完整参数设置界面？",
  "Looks": "外观",
  "loop": "循环",
  "low": "低",
  "lower case": "lower case(小写形式)",
  "m": "m",
  "Magnification": "UI缩放率",
  ...
  "make this morph unmovable": "固定morph",
  "map _ of _ to code _": "把 _ 的 _ 转成代码 _",
  "map _ over _": "映射 _ 在 _",
  "map _ to _ _": "设置 _ 的 _ 为 _",
  "March": "三月",
  "mark own": "标记自有属性",
  "max": "max",
  "Max slots": "最大参数数量",
  ...
  "multi-line": "多行文本参数",
  "Multiple inputs (value is list of inputs)": "可变参数类型 (将形参的多个输入项视为一个列表)",
  "my": "我的",
  "my _": "我的 _",
  "my anchor": "我的组合体",
  "my parts": "我的组合面",
  ...
  "Pipette tool (pick a color from anywhere shift: fill color)": "滴管工具(从任何地方取色, Shift键: 填充颜色)",
  "Pipette tool (pick a color from anywhere shift: secondary color)": "选色器工具(shift键: 从任何地方选择颜色)",
  "pitch": "音调",
  "pivot": "支点",
  "pixel": "像素",
  "pixels": "每个像素对应的RGBA列表",
  "pixelate": "像素化",
  "Plain prototype labels": "全局性积木部分预览？",
  "Play": "播放",
  ...
  "presentation (1.4x)": "较大 (1.4倍)",
  "pressed": "按下",
  "previous": "上一个",
  "primitive": "primitive(是否为原生积木？)",
  "primitives": "所有原生积木",
  "Primitives palette": "转换为原生积木",
  "Privacy...": "隐私政策...",
  "processes": "线程数量",
  "product": "乘积",
  "Project Notes": "作品备注",
  ...
  "rename all...": "重命名所有访问其值的变量...",
  "rename background": "重命名背景",
  "rename costume": "重命名造型",
  "rename only this reporter": "仅重命名当前返回类积木",
  "rename sound": "重命名声音",
  "rename...": "改名为...",
  ...
  "save project data as XML\nto your downloads folder": "把作品本身作为XML文件，保存到电脑里",
  "Save to disk": "保存到磁盘",
  "Saved!": "已保存！",
  "saved.": "作品已保存.",
  ...
  "second": "秒钟",
  "select": "选择",
  "Select a costume from the media library": "从素材库中挑选一个造型",
  "Select a sound from the media library": "从素材库中挑选一个声音",
  ...
  "spec...": "描述...",
  "special": "特殊参数类型",
  "specify the distance the hand has to move\nbefore it picks up an object": "在拖动东西前，鼠标需要移动的最小距离",
  "spectrum": "声谱",
  "speech bubble": "对话气泡",
  "speechBubble": "对话框",
  ...
  "stretch _ x: _ y: _ %": "拉伸 _ 宽度比 _ % 高度比 _ %",
  "String": "字符串",
  "string": "字符串",
  ...
  "the predicate takes too long for a custom hat block": "判断类函数对于自定义事件类积木来说需要太长时间",
  "The question came up at": "问题出现在以下地方：",
  "there are currently no unused\nglobal custom blocks in this project": "这个作品里目前没有\n没用到的全局自制积木",
  ...
  "turn pen trails into new background...": "将画笔轨迹转为新背景...",
  "turn pen trails into new costume...": "把画笔轨迹转为新造型...",
  "turnBack": "向后转",
  "turnForward": "向前转",
  "turnLeft": "向左转",
  "turnRight": "向右转",
  ...
  "uncheck to disable\nmulti-column list views": "原样呈现多维(如2维)列表",
  ...
  "uncheck to disable\nusing operators on lists and tables": "取消勾选以禁用作用于N维列表(包括“表格”)的超级运算符",
  "uncheck to disable\nvirtual keyboard support for mobile devices": "不使用移动设备的虚拟键盘",
  "uncheck to disable\nwrapping list indices": "取消勾选以禁用列表索引循环",
  "uncheck to disable alternating\ncolors for nested block": "使用相同的颜色\n标识处于同一积木类型的嵌套积木",
  "uncheck to disable dynamic\nlabels for variadic inputs": "可变参数不使用动态标记",
  ...
  "uncheck to drag media\nand blocks out of\nwatchers and balloons": "允许从返回框或对话框里拖动造型、声音或积木",
  ...
  "uncheck to switch pen colors\nand graphic effects to HSV": "取消勾选后将画笔颜色模式设置为HSV模式",
  ...
  "uncheck to use the input\ndialog in short form": "编辑参数时，显示更简洁的设置界面",
  "uncompile": "取消编译",
  ...
  "Uploading": "上传中",
  "upper case": "upper case(大写形式)",
  "Upvar - make internal variable visible to caller": "回传变量类型 - 令参数本身作为变量使用",
  "url...": "网址...",
  "Use CPU for graphics": "使用CPU绘制图形",
  "Use custom blocks": "转换为自制积木",
  ...
  "Enforce input types": "全局性严格类型检查(仅限于当前作品)",
  "disable dropping reporters\ninto unmatching slots": "勾选以允许积木参数\n选择性嵌入类型匹配的表达式",
  ...
  "unrestricted float": "无限制单精度浮点数",
  "unrestricted double": "无限制双精度浮点数",
  "bigint": "大整数",
  "username": "用户名",
  "password": "密码",
  "keepalive": "保持连接时间",
  "connection callback": "回调函数(连接成功后)",
  "QoS": "QOS",
  "retain flag": "是否保留消息？",
  "timeout": "最长等待时间",
  "binary mode": "二进制传输模式？",
  "sub binary mode": "二进制发送模式？",
  "pub binary mode": "二进制接收模式？",
  "append response topic": "附带响应主题？",
  "as byte list": "当作字节列表",
  "offset x": "的 x",
  "ide": "图形化编辑器(IDE)",
  "corral": "角色区",
