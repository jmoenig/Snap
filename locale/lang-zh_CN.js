SnapTranslator.dict.zh_CN = { ...SnapTranslator.dict.zh_CN,
    ...
    "Command\n(C-shape)": "执行类(C型参数)",
    "Command\n(inline)": "执行类\n(嵌入)",
    "Command (C-shape)": "执行类(C型参数)",
    "Command (inline)": "执行类 (嵌入)",
    ...
    "Exported!": "导出好了！",
    "Extension blocks": "是否使用自定义扩展(函数(组))",
    ...
    "Hyper blocks support": "支持Hyperblocks特性",
    ...
    "January": "一月",
    "JavaScript extensions": "解除JavaScript Function积木权限",
    "JavaScript extensions for Snap! are turned off": "未接触JS Function积木权限",
    ...
    "check to show extension\nprimitives in the palette": "显示“extension”积木",
    "check to show in palette": "显示在面板里",
    "check to support\nnative JavaScript functions": "取消勾选以禁用JavaScript Function积木权限",
    ...
    "set slot _ to _": "将输入项(槽) _ 的值设为 _",
    ...
    "uncheck to hide extension primitives in the palette": "隐藏“extension”积木",
    ...
    "when slot _ signals _": "当实参(槽) _ 接收到操作 _",
    "whirl": "旋转",
    "whitespace": "空符",
    "width": "宽度",
    "with data": "带数据",
    ...
    "uniques": "集合化",
    "separator": "separator(相邻两参数中缀)",
    "collapse": "collapse(列表输入前缀)",
    "expand": "expand(各参数前缀)",
    ...
    "primitive": "primitive(是否为原语？)",
    "comment": "comment(函数文档)",
    "selector": "积木面板",
    "replaceables": "可嵌入表达式？",
    "separators": "separators(各参数中缀)",
    "collapses": "collapses(列表输入前缀)",
    "expands": "expands(各参数前缀)",
