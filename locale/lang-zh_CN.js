SnapTranslator.dict.zh_CN = {
    ...
    "Bar charts": "条形图",
    "Bignums, rationals, complex #s": "大数、有理数、复数",
    "Birth date": "出生日期",
    "Bitmap": "位图",
    "Block Editor": "积木编辑器",
    ...
    "EXPERIMENTAL! check to enable live custom control structures": "实验性功能！勾选以启用实时自定义控制结构",
    "EXPERIMENTAL! check to enable support for compiling": "实验性功能！勾选以启用编译支持",
    ...
    "EXPERIMENTAL! uncheck to disable live custom control structures": "实验性功能！取消勾选以禁用实时自定义控制结构",
    "EXPERIMENTAL! uncheck to disable live support for compiling": "实验性功能！取消勾选以禁用实时编译支持",
    ...
    "July": "七月",
    "June": "六月",
    "Just the crayons, without the rest of the colors library. Fast and simple.": "只有蜡笔，没有其余的颜色库。快速而简单。",
    ...
    "false": "假",
    "file": "文件",
    "file menu import hint": "文件菜单导入提示",
    "fill": "填充",
    "fill page...": "填满页面...",
    ...
    "label": "",
    "language_name": "简体中文",
    "language_translator": "五百刀/邓江华/孟锡峰/曹儒林/moodykeke",
    "large": "大型",
    "last": "最后一个",
    "last changed": "最后修改",
    "last_changed": "2023-09-15",
    "launch _ _": "启动 _ _",
    "left": "",
    "left arrow": "←",
    "length": "长度",
    ...
    "uncheck to confine auto-wrapping to top-level block stacks": "取消选中以将自动换行限制在顶级块堆栈",
    ...
    "uncheck to disable camera support": "取消选中以禁用相机支持",
    "uncheck to disable dropping commands in reporter rings": "取消选中以禁用报告器环中的删除命令",
