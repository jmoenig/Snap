...
SyntaxElementMorph.prototype.partLabelMorphs = {
    // This dictionary returns all the parts that Snap! knows about.
    // Each item is a function that gets called in the context of
    // a SyntaxElementMorph with `spec` as an input.
    '%imgsource': function () {
    ...
    '%inputs': function () {
        var part = new MultiArgMorph('%s', 'with inputs');
        part.isStatic = false;
        part.canBeEmpty = false;
        return part;
    },
    '%scriptVars': function () {
        var part = new MultiArgMorph('%t', null, 1, spec);
        part.canBeEmpty = false;
        return part;
    },
    '%blockVars': function () {
        var part = new MultiArgMorph('%t', 'block variables', 0, spec);
        part.canBeEmpty = false;
        return part;
    },
    '%parms': function () {
        var part = new MultiArgMorph('%t', 'Input Names:', 0, spec);
        part.canBeEmpty = false;
        return part;
    },
    '%ringparms': function (spec) {
        var part = new MultiArgMorph(
            '%t',
            'input names:',
            0,
            spec
    ...
    '%words': function () {
        var part = new MultiArgMorph('%s', null, 0);
    ...
    '%inputName': function () {
        var part = new ReporterBlockMorph();
    ...
    '%obj': function () {
        return new ArgMorph('object');
    },
    '%n': function () {
        return new InputSlotMorph(null, true);
    },
    '%dir': function () {
        var part = new InputSlotMorph(
            null,
    ...
    '%col': function () { // collision detection
        return new InputSlotMorph(
            null,
            false,
            'collidablesMenu',
    ...
    '%dst': function () { // distance measuring
        var part = new InputSlotMorph(
            null,
            false,
            'distancesMenu',
    ...
    '%l': function () {
        return new ArgMorph('list');
    },
    '%b': function () {
        return new BooleanSlotMorph(null, true);
    },
    '%boolUE': this['%b'],
    '%cmd': function () {
        return new CommandSlotMorph();
    },
    '%rc': function () {
        var part = new RingCommandSlotMorph();
        part.isStatic = true;
        return part;
    },
    '%rr': function () {
        var part = new RingReporterSlotMorph();
        part.isStatic = true;
        return part;
    },
    '%rp': function () {
        var part = new RingReporterSlotMorph(true);
        part.isStatic = true;
        return part;
    },
    '%c': function () {
        var part = new CSlotMorph();
        part.isStatic = true;
        return part;
    },
    '%cs': function () {
        return new CSlotMorph(); // non-static
    },
    '%cl': function () {
        var part = new CSlotMorph();
    ...
    '%clr': function () {
        var part = new ColorSlotMorph();
        part.isStatic = true;
        return part;
    },
    '%t': function () {
        return new TemplateSlotMorph('a');
    },
    '%upvar': function () {
        return new TemplateSlotMorph('\u2191'); // up-arrow
    },
    '%f': function () {
        return new FunctionSlotMorph();
    },
    '%r': function () {
        return new ReporterSlotMorph();
    },
    '%p': function () {
        return new ReporterSlotMorph(true);
    },
    // code mapping (experimental)
    '%codeListPart': function () {
        var part = new InputSlotMorph(
            null, // text
            false, // numeric?
            {
    ...
    // symbols:
    '%turtle': function () {
        var part = new SymbolMorph('turtle');
    ...
    '%turtleOutline': function () {
        var part = new SymbolMorph('turtleOutline');
    ...
    '%clockwise': function () {
        var part = new SymbolMorph('turnRight');
    ...
    '%counterclockwise': function () {
        var part = new SymbolMorph('turnLeft');
        part.size = this.fontSize * 1.5;
        part.color = new Color(255, 255, 255);
        part.isProtectedLabel = false; // zebra colors
        part.shadowColor = this.color.darker(this.labelContrast);
    ...
    '%stop': function () {
        var part = new SymbolMorph('octagon');
        part.size = this.fontSize * 1.5;
    ...
    '%pause': function () {
        var part = new SymbolMorph('pause');
        part.size = this.fontSize;
...
SyntaxElementMorph.prototype.labelPart = function (spec) {
    ...
    if (spec[0] === '%' &&
        ...
        if (this.partLabelMorphs[spec]) {
            return this.partLabelMorphs[spec].call(this, spec);
