...
Jens Mönig, Bernat Romagosa, August 10, 2026
...
|hideCloudMenu:	|bool	|hide/show the cloud menu button in the tool bar only|
...
|noShare:    |bool    |hide/show the share project button option in the project dialog|
