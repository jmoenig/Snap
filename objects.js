...
BlockEditorMorph, BlockDialogMorph, PrototypeHatBlockMorph, _, _nop, _expr,
...
SpriteMorph.prototype.categoryLabel = function (category) {
    var labels = {
        'motion': _('Motion'),
        'control': _('Control'),
        'looks': _('Looks'),
...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        turn: {
            ...
            type: 'command',
            category: 'motion',
            spec: _nop('turn %clockwise %n degrees'),
            defaults: [15]
        },
        turnLeft: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: _nop('turn %counterclockwise %n degrees'),
            defaults: [15]
        },
        setHeading: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: _nop('point in direction %dir')
        },
        doFaceTowards: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: _nop('point towards %dst')
        },
        gotoXY: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: _nop('go to x: %n y: %n'),
            defaults: [0, 0]
        },
        doGotoObject: {
            only: SpriteMorph,
        ...
        doGlide: {
            ...
            type: 'command',
            category: 'motion',
            spec: _nop('glide %n secs to x: %n y: %n'),
            defaults: [1, 0, 0]
        },
        changeXPosition: {
            only: SpriteMorph,
        ...
        bounceOffEdge: {
            ...
            type: 'command',
            category: 'motion',
            spec: _nop('if on edge, bounce')
        },
        xPosition: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'motion',
            spec: _nop('x position')
        },
        yPosition: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'motion',
            spec: _nop('y position')
        },
        direction: {
            only: SpriteMorph,
            type: 'reporter',
        ...
        doSwitchToCostume: {
            type: 'command',
            category: 'looks',
            spec: _nop('switch to costume %cst')
        },
        doWearNextCostume: {
            type: 'command',
            category: 'looks',
            spec: _nop('next costume')
        },
        getCostumeIdx: {
            type: 'reporter',
            category: 'looks',
        ...
        changeEffect: {
            type: 'command',
            category: 'looks',
            spec: _nop('change %eff effect by %n'),
            defaults: [null, 25]
        },
        setEffect: {
            type: 'command',
            category: 'looks',
            spec: _nop('set %eff effect to %n'),
            defaults: [null, 0]
        },
        clearEffects: {
            type: 'command',
            category: 'looks',
            spec: _nop('clear graphic effects')
        },
        changeScale: {
            only: SpriteMorph,
            type: 'command',
            category: 'looks',
            spec: _nop('change size by %n'),
            defaults: [10]
        },
        setScale: {
            only: SpriteMorph,
        ...
        comeToFront: {
            ...
            type: 'command',
            category: 'looks',
            spec: _nop('go to front')
        },
        goBack: {
            only: SpriteMorph,
            type: 'command',
            category: 'looks',
            spec: _nop('go back %n layers'),
            defaults: [1]
        },
        doScreenshot: {
            type: 'command',
            category: 'looks',
            spec: _nop('save %imgsource as costume named %s'),
            defaults: [['pen trails'], _('screenshot')]
        },
        ...
        alert: {
            ...
            type: 'command',
            category: 'looks',
            spec: _nop('alert %mult%s')
        },
        log: {
            dev: true,
            type: 'command',
            category: 'looks',
            spec: _nop('console log %mult%s')
        },
        ...
        playSound: {
            type: 'command',
            category: 'sound',
            spec: _nop('play sound %snd')
        },
        doPlaySoundUntilDone: {
            type: 'command',
            category: 'sound',
            spec: _nop('play sound %snd until done')
        },
        doStopAllSounds: {
            type: 'command',
            category: 'sound',
            spec: _nop('stop all sounds')
        },
        doRest: {
            type: 'command',
            category: 'sound',
            spec: _nop('rest for %n beats'),
            defaults: [0.2]
        },
        doPlayNote: {
            type: 'command',
            category: 'sound',
            spec: _nop('play note %note for %n beats'),
            defaults: [60, 0.5]
        },
        doSetInstrument: {
            type: 'command',
            category: 'sound',
            spec: _nop('set instrument to %inst'),
            defaults: [1]
        },
        doChangeTempo: {
            type: 'command',
            category: 'sound',
            spec: _nop('change tempo by %n'),
            defaults: [20]
        },
        doSetTempo: {
            type: 'command',
            category: 'sound',
            spec: _nop('set tempo to %n bpm'),
            defaults: [60]
        },
        getTempo: {
            type: 'reporter',
        ...
        setColor: {
            ...
            type: 'command',
            category: 'pen',
            spec: _nop('set pen color to %clr')
        },
        changeHue: {
            only: SpriteMorph,
            type: 'command',
            category: 'pen',
            spec: _nop('change pen color by %n'),
            defaults: [10]
        },
        setHue: {
            only: SpriteMorph,
        ...
        changeBrightness: {
            ...
            type: 'command',
            category: 'pen',
            spec: _nop('change pen shade by %n'),
            defaults: [10]
        },
        setBrightness: {
            only: SpriteMorph,
        ...
        changeSize: {
            ...
            type: 'command',
            category: 'pen',
            spec: _nop('change pen size by %n'),
            defaults: [1]
        },
        setSize: {
            only: SpriteMorph,
        ...
        receiveGo: {
            type: 'hat',
            category: 'control',
            spec: _nop('when %greenflag clicked')
        },
        receiveKey: {
            type: 'hat',
            category: 'control',
            spec: _nop('when %keyHat key pressed')
        },
        receiveInteraction: {
            type: 'hat',
            category: 'control',
            spec: _nop('when I am %interaction'),
            defaults: ['clicked']
        },
        receiveMessage: {
            type: 'hat',
            category: 'control',
            spec: _nop('when I receive %msgHat')
        },
        receiveCondition: {
            type: 'hat',
            category: 'control',
        ...
        doBroadcast: {
            type: 'command',
            category: 'control',
            spec: _nop('broadcast %msg')
        },
        doBroadcastAndWait: {
            type: 'command',
            category: 'control',
            spec: _nop('broadcast %msg and wait')
        },
        getLastMessage: {
            type: 'reporter',
            category: 'control',
        ...
        doWait: {
            type: 'command',
            category: 'control',
            spec: _nop('wait %n secs'),
            defaults: [1]
        },
        doWaitUntil: {
            type: 'command',
            category: 'control',
            spec: _nop('wait until %b')
        },
        doForever: {
            type: 'command',
            category: 'control',
        ...
        doRepeat: {
            type: 'command',
            category: 'control',
            spec: _nop('repeat %n %c'),
            defaults: [10]
        },
        doUntil: {
            type: 'command',
            category: 'control',
            spec: _nop('repeat until %b %c')
        },
        doIf: {
            type: 'command',
            category: 'control',
    ...
    /* migrated to a newer block version:
        ...
        doStop: {
            type: 'command',
            category: 'control',
            spec: _nop('stop script')
        },
        doStopAll: {
            type: 'command',
            category: 'control',
            spec: _nop('stop all %stop')
        },
    */
    ...
    /* migrated to doStopThis:
        ...
        doStopOthers: {
            type: 'command',
            category: 'control',
            spec: _nop('stop %stopOthersChoices')
        },
    */
        ...
        doRun: {
            type: 'command',
            category: 'control',
            spec: _nop('run %cmdRing %inputs')
        },
        fork: {
            type: 'command',
            category: 'control',
            spec: _nop('launch %cmdRing %inputs')
        },
        evaluate: {
            type: 'reporter',
            category: 'control',
            spec: _nop('call %repRing %inputs')
        },
        doReport: {
            type: 'command',
            category: 'control',
    ...
    /*
        doStopBlock: { // migrated to a newer block version
            type: 'command',
            category: 'control',
            spec: _nop('stop block')
        },
    */
        doCallCC: {
            type: 'command',
            category: 'control',
            spec: _nop('run %cmdRing w/continuation')
        },
        reportCallCC: {
            type: 'reporter',
            category: 'control',
            spec: _nop('call %cmdRing w/continuation')
        },
        doWarp: {
            type: 'command',
            category: 'other',
        ...
        doTellTo: {
            type: 'command',
            category: 'control',
            // spec: _nop('tell %spr to %cl' // I liked this version much better, -Jens)
            spec: _nop('tell %spr to %cmdRing %inputs')
        },
        reportAskFor: {
            type: 'reporter',
            category: 'control',
            spec: _nop('ask %spr for %repRing %inputs')
        },
        ...
        receiveOnClone: {
            type: 'hat',
            category: 'control',
            spec: _nop('when I start as a clone')
        },
        createClone: {
            type: 'command',
            category: 'control',
            spec: _nop('create a clone of %cln')
        },
        newClone: {
            type: 'reporter',
            category: 'control',
            spec: _nop('a new clone of %cln'),
            defaults: [['myself']]
        },
        removeClone: {
            type: 'command',
            category: 'control',
            spec: _nop('delete this clone')
        },
        ...
        reportTouchingObject: {
            ...
            type: 'predicate',
            category: 'sensing',
            spec: _nop('touching %col ?')
        },
        reportTouchingColor: {
            only: SpriteMorph,
            type: 'predicate',
            category: 'sensing',
            spec: _nop('touching %clr ?')
        },
        reportColorIsTouchingColor: {
            only: SpriteMorph,
            type: 'predicate',
            category: 'sensing',
            spec: _nop('color %clr is touching %clr ?')
        },
        colorFiltered: {
            dev: true,
            type: 'reporter',
            category: 'sensing',
            spec: _nop('filtered for %clr')
        },
        reportStackSize: {
            dev: true,
            type: 'reporter',
            category: 'sensing',
            spec: _nop('stack size')
        },
        reportFrameCount: {
            dev: true,
            type: 'reporter',
        ...
        doAsk: {
            type: 'command',
            category: 'sensing',
            spec: _nop('ask %s and wait'),
            defaults: [_('what\'s your name?')]
        },
        ...
        reportMouseDown: {
            type: 'predicate',
            category: 'sensing',
            spec: _nop('mouse down?')
        },
        reportKeyPressed: {
            type: 'predicate',
            category: 'sensing',
            spec: _nop('key %key pressed?')
        },
    /*
        reportDistanceTo: { // has been superseded by reportRelationTo
            type: 'reporter',
            category: 'sensing',
            spec: _nop('distance to %dst')
        },
    */
        reportRelationTo: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'sensing',
            spec: _nop('%rel to %dst'),
            defaults: [['distance']]
        },
        doResetTimer: {
            type: 'command',
            category: 'sensing',
            spec: _nop('reset timer')
        },
        ...
        reportIsFastTracking: {
            type: 'predicate',
            category: 'sensing',
            spec: _nop('turbo mode?')
        },
        doSetFastTracking: {
            type: 'command',
            category: 'sensing',
            spec: _nop('set turbo mode to %b')
        },
        reportDate: {
            type: 'reporter',
            category: 'sensing',
            spec: _nop('current %dates')
        },
        reportGet: {
            type: 'reporter',
            category: 'sensing',
        ...
        reportJoinWords: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('join %words'),
            defaults: [_('hello') + ' ', _('world')]
        },
        reportLetter: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('letter %n of %s'),
            defaults: [1, _('world')]
        },
        reportStringSize: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('length of %s'),
            defaults: [_('world')]
        },
        reportUnicode: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('unicode of %s'),
            defaults: ['a']
        },
        reportUnicodeAsLetter: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('unicode %n as letter'),
            defaults: [65]
        },
        reportIsA: {
            type: 'predicate',
            category: 'operators',
            spec: _nop('is %s a %typ ?'),
            defaults: [5]
        },
        reportIsIdentical: {
            type: 'predicate',
            category: 'operators',
            spec: _nop('is %s identical to %s ?')
        },
        reportTextSplit: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('split %s by %delim'),
            defaults: [_('hello') + ' ' + _('world'), " "]
        },
        reportJSFunction: { // experimental
            type: 'reporter',
            category: 'operators',
            spec: _nop('JavaScript function ( %mult%s ) { %code }')
        },
    ...
    /*
        reportScript: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('the script %parms %c')
        },
        reify: {
            type: 'reporter',
            category: 'operators',
            spec: _nop('the %f block %parms')
        },
    */
        ...
        doSetVar: {
            type: 'command',
            category: 'variables',
            spec: _nop('set %var to %s'),
            defaults: [null, 0]
        },
        doChangeVar: {
            type: 'command',
            category: 'variables',
            spec: _nop('change %var by %n'),
            defaults: [null, 1]
        },
        doShowVar: {
            type: 'command',
            category: 'variables',
            spec: _nop('show variable %var')
        },
        doHideVar: {
            type: 'command',
            category: 'variables',
            spec: _nop('hide variable %var')
        },
        doDeclareVariables: {
            type: 'command',
            category: 'other',
            spec: _nop('script variables %scriptVars')
        },
        ...
        reportCONS: {
            type: 'reporter',
            category: 'lists',
            spec: _nop('%s in front of %l')
        },
        reportListItem: {
            type: 'reporter',
            category: 'lists',
            spec: _nop('item %idx of %l'),
            defaults: [1]
        },
        reportCDR: {
            type: 'reporter',
            category: 'lists',
            spec: _nop('all but first of %l')
        },
        reportListLength: {
            type: 'reporter',
            category: 'lists',
            spec: _nop('length of %l')
        },
        reportListContainsItem: {
            type: 'predicate',
            category: 'lists',
            spec: _nop('%l contains %s'),
            defaults: [null, _('thing')]
        },
        doAddToList: {
            type: 'command',
            category: 'lists',
            spec: _nop('add %s to %l'),
            defaults: [_('thing')]
        },
        doDeleteFromList: {
            type: 'command',
            category: 'lists',
            spec: _nop('delete %ida of %l'),
            defaults: [1]
        },
        doInsertInList: {
            type: 'command',
            category: 'lists',
            spec: _nop('insert %s at %idx of %l'),
            defaults: [_('thing'), 1]
        },
        doReplaceInList: {
            type: 'command',
            category: 'lists',
            spec: _nop('replace item %idx of %l with %s'),
            defaults: [1, null, _('thing')]
        },
        ...
        reportMap: {
            ...
            type: 'reporter',
            category: 'lists',
            spec: _nop('map %repRing over %l')
        },
        doForEach: {
            dev: true,
            type: 'command',
            category: 'lists',
            spec: _nop('for %upvar in %l %cl'),
            defaults: [_('each item')]
        },
        ...
        doMapCodeOrHeader: { // experimental
            type: 'command',
            category: 'other',
            spec: _nop('map %cmdRing to %codeKind %code')
        },
        doMapValueCode: { // experimental
            type: 'command',
            category: 'other',
            spec: _nop('map %mapValue to code %code'),
            defaults: [['String'], '<#1>']
        },
    /* obsolete - superseded by 'doMapValue'
        doMapStringCode: { // experimental
            type: 'command',
            category: 'other',
            spec: _nop('map String to code %code'),
            defaults: ['<#1>']
        },
    */
        doMapListCode: { // experimental
            type: 'command',
            category: 'other',
            spec: _nop('map %codeListPart of %codeListKind to code %code')
        },
        reportMappedCode: { // experimental
            type: 'reporter',
            category: 'other',
            spec: _nop('code of %cmdRing')
        }
    };
};
...
SpriteMorph.prototype.blockTemplates = function (category) {
    ...
    function addVar(pair) {
        ...
        if (pair) {
            if (myself.isVariableNameInUse(pair[0], pair[1])) {
                myself.inform(_('that name is already in use'));
            } else {
    ...
    // for debugging: ///////////////
        ...
        if (this.world().isDevMode) {
            blocks.push('-');
            txt = new TextMorph(_('development mode\ndebugging primitives:'));
            txt.fontSize = 9;
...
SpriteMorph.prototype.freshPalette = function (category) {
    ...
    searchButton.hint = _('find blocks...');
    ...
    makeButton.hint = _('Make a block...');
    ...
    [this.customBlocks, stage.globalBlocks].forEach(function (blocksList) {
        blocksList.forEach(function (definition) {
            if (contains(types, definition.type)) {
                var spec = _expr(definition.blockSpec()).toLowerCase(),
    ...
    Object.keys(blocksDict).forEach(function (selector) {
        if (!StageMorph.prototype.hiddenPrimitives[selector] &&
            ...
            var block = blocksDict[selector],
                spec = (_expr(block.alias || block.spec)).toLowerCase(),
                rel = relevance(labelOf(spec), search);
            if (
                (rel !== -1) &&
                    (!block.dev) &&
...
SpriteMorph.prototype.reporterize = function (expressionString) {
    ...
    function blockFromAST(ast) {
        ...
        monads.concat([_('true'), _('false')]).forEach(function (word) {
            reverseDict[word.toLowerCase()] = word;
        });
...
SpriteMorph.prototype.addCostume = function (costume) {
    if (!costume.name) {
        costume.name = _('costume') + (this.costumes.length() + 1);
    }
...
SpriteMorph.prototype.userMenu = function () {
    ...
    if (!this.isTemporary) {
        menu.addItem(_('duplicate'), 'duplicate');
        if (StageMorph.prototype.enableInheritance) {
            menu.addItem(_('clone'), 'instantiate');
            menu.addLine();
        }
    }
    menu.addItem(_('delete'), 'remove');
    menu.addItem(_('move'), 'moveCenter');
    menu.addItem(_('rotate'), 'setRotation');
    if (this.costume) {
        menu.addItem(
            _('pivot'),
            'moveRotationCenter',
            _('edit the costume\'s\nrotation center')
        );
    }
    if (this.isTemporary) {
        if (StageMorph.prototype.enableInheritance) {
    ...
    if (this.anchor) {
        menu.addItem(
            _('detach from {{ name }}', this.anchor.name),
            'detachFromAnchor'
        );
    }
    if (this.parts.length) {
        menu.addItem(_('detach all parts'), 'detachAllParts');
    }
    menu.addItem(_('export...'), 'exportSprite');
    return menu;
};
...
SpriteMorph.prototype.newClone = function (immediately) {
    ...
    if (isNil(clone)) {
        throw new Error(_('exceeding maximum number of clones'));
    }
    return clone;
};
...
SpriteMorph.prototype.setRotationCenter = function (absoluteCoordinate) {
    var delta, normal;
    if (!this.costume) {
        throw new Error(_('setting the rotation center requires a costume'));
    }
...
StageMorph.prototype.developersMenu = function () {
    ...
    menu.addItem(
        ...
        _('terminate all running threads')
    );
    return menu;
};
...
StageMorph.prototype.blockTemplates = function (category) {
    ...
    if (cat === 'motion') {
        ...
        txt = new TextMorph(_('Stage selected:\nno motion primitives'));
        txt.fontSize = 9;
        txt.setColor(this.paletteTextColor);
        blocks.push(txt);
        blocks.push('=');
...
StageMorph.prototype.userMenu = function () {
    ...
    menu.addItem(_('edit'), 'edit');
    menu.addItem(_('show all'), 'showAll');
    menu.addItem(
        _('pic...'),
        function () {
            ide.saveCanvasAs(
    ...
    menu.addItem(
        ...
        ide.currentSprite instanceof SpriteMorph
            ? _('turn all pen trails and stamps\n' +
...
StageMorph.prototype.reportPenTrailsAsCostume = function () {
    return new Costume(
        this.trailsCanvas,
        this.newCostumeName(_('Background'))
    );
};
...
Costume.prototype.editRotationPointOnly = function (aWorld) {
    ...
    txt = new TextMorph(
        _('click or drag crosshairs to move the rotation center'),
        dialog.fontSize,
        dialog.fontStyle,
        true,
        false,
    ...
    dialog.labelString = _('Costume Editor');
    dialog.createLabel();
    dialog.setPicture(editor);
    dialog.addBody(txt);
    dialog.addButton('ok', _('OK'));
    dialog.addButton('cancel', _('Cancel'));
    dialog.fixLayout();
    dialog.drawNew();
    dialog.fixLayout();
    dialog.popUp(aWorld);
...
Note.prototype.setupContext = function () {
    ...
    if (!AudioContext) {
        throw new Error(_('Web Audio API is not supported\nin this browser'));
    }
...
WatcherMorph.prototype.userMenu = function () {
    ...
    menu.addItem(
        (this.style === 'normal' ? on : off) + _('normal'),
        'styleNormal'
    );
    menu.addItem(
        (this.style === 'large' ? on : off) + _('large'),
        'styleLarge'
    );
    if (this.target instanceof VariableFrame) {
        menu.addItem(
            (this.style === 'slider' ? on : off) + _('slider'),
            'styleSlider'
        );
        menu.addLine();
        menu.addItem(
                        ...
                        function txtOnlyMsg(ftype) {
                            ide.inform(
                                ...
                                _(
                                    ...
                                    'You selected a file of type "{{ type }}".',
                                    { appName: 'Snap!', type: ftype }
                                )
                            );
                        }
